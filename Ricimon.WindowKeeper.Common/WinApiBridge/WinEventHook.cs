...
{
    // Adapted from https://stackoverflow.com/questions/48767318/move-window-when-external-applications-window-moves
    ...
    public class WinEventHook
    {
        ...
        public enum SWEH_dwFlags : uint
        {
            ...
            /// <summary>
            /// Don't callback for events on installer's process
            /// </summary>
                                               ...
                                               uint idProcess, uint idThread)
        {
            ...
            return NativeMethods.SetWinEventHook(_eventFrom, _eventTo,
                                                 IntPtr.Zero, _delegate,
                                                 idProcess, idThread,
                                                 WinEventHookInternalFlags);
        }

        public static IntPtr WinEventHookOne(SWEH_Events _event, 
                                             WinEventDelegate _delegate,
                                             uint idProcess, uint idThread)
        {
            new UIPermission(UIPermissionWindow.AllWindows).Demand();
            return NativeMethods.SetWinEventHook(_event, _event,
                                                 IntPtr.Zero, _delegate,
                                                 idProcess, idThread,
                                                 WinEventHookInternalFlags);
        }
        ...
        public static string GetWindowText(IntPtr hWnd, int textLength)
        {
